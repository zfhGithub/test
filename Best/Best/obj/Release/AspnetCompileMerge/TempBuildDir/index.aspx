...
<div id='banner' class='banner extBanner' style='background:url( ) 50% 50% no-repeat;height:555px'  normalheight='555' defaultwidth='960'>
	<div class='banner defaultBannerMain' style='background:url( ) 50% 50% no-repeat;height:555px'></div>
...
<div class='titleText titleText325'><span><script>document.write(best.cptj); </script></span></div>
</td>
...
<a hidefocus='true'  href='pr.aspx'><span><script>document.write(best.more); </script>&#x3e;&#x3e;</span></a>
</span>
</div>
&nbsp;</div>
</td>
...
<div class='titleText titleText370'><span><script>document.write(best.cpzs); </script></span></div>
</td>
...
<div class='titleText titleText371'><span><script>document.write(best.submitmessage);</script> </span></div>
</td>
...
<div class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.name);</script>：</div><input class='g_itext msgSubmit_ipt msgSubmit_isMust' id='reqName'   type='text' size='14' maxlength='50'value=''><font class='star'>*</font></div>
<div class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.email);</script>：</div><input class='g_itext msgSubmit_ipt ' id='reqEmail'  type='text' size='14' value='' maxlength='50'></div>
<div class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.phone);</script>：</div><input class='g_itext msgSubmit_ipt ' id='reqPhone'  type='text' size='14' value='' maxlength='50'></div>
</div>
<div class='msgAddText_N'><div style='float:left;' class='msgSubmit_overToPoint'><script>document.write(best.content);</script>：</div><textarea class='g_textarea' id='reqContent' rows='3' cols='50' placeholder='' style='width:510px;' maxlength='1000'></textarea>
</div>
 
<div class='msgAddButton_N'>
<div style='float:left;' class='msgSubmit_overToPoint'>&nbsp;</div><div class='m_ibutton m_ibutton3'>
<div class='left'></div><div class='middle' style='min-width:106px;' onclick='msgSubmitAddMsg()' ><script>document.write(best.submitmessage);</script></div><div class='right'></div></div></div></div>
</div>
</div>
</td>
...
var _templateBannerData = {
    ...
    "n": [
        ...
        { "t": 0, "i": "banner3", "e": 0, "u": "", "el": "", "er": "", "p": "/image/banner3.jpg", "w": 960, "h": 450 }],
    "ce": { "c1": "#000", "c2": "#FFFFFF" }, "s": 4, "pl": 0, "o": true, "t": 10, "i": 4000, "a": 1500, "h": false, "p": 0, "pt": 0, "bt": 1, "f": {}, "c": 3, "at": 0, "ws": false
};		// 模版的数据

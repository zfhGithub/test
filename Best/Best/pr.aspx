...
<div class='titleText titleText372'><span>产品分类</span></div>
</td>
...
<a hidefocus='true' href='pr.aspx?classid=<%= classTable.Rows[i]["id"] %>' title='<%= classTable.Rows[i]["className"] %>' ><%= classTable.Rows[i]["className"] %></a>
</td>
...
<div class='titleText titleText22'><span>产品列表</span></div>
</td>

...
<tr>
<td valign='top' class='propName g_minor'><script>document.write(best.numbering)</script> ：</td>
<td class='propValue'>
<span><%= product["GoodsNo"] %>  </span>
</td>
</tr>
</table>
</div>
...
<div id='detDescSwitch' class='tabSwitch pdNoLeftBorder'  onclick='javascript:Site.productInfoSwitchClick("detail");return;'><span class='tabTitle'><script>document.write(best.productdetails)</script></span><div class=' g_borderSelected pdComSwitchBottomDiv' ></div></div><div class='g_borderSelected pdSwitchRightTd' valign='bottom'><div class=' g_borderSelected pdComSwitchBottomDiv' ></div></div></div><div style='clear:both;'></div>

...
<div class='titleText titleText15'><span><script>document.write(best.message);</script></span></div>
</td>
...
<div class='msgSAdd_N'>
<div class='msgAddTitle_N'><script>document.write(best.comment);</script>：</div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.name);</script>：</div><input style='width:246px;' class='g_itext msg_ipt msg_isMust' id='reqName' name='姓名' type='text' size='14' maxlength='50'value=''><font class='star'>*</font></div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.email);</script>：</div><input style='width:246px;' class='g_itext msg_ipt ' id='reqEmail' name='邮箱' type='text' size='14' maxlength='50'value=''></div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'><script>document.write(best.phone);</script>：</div><input style='width:246px;' class='g_itext msg_ipt ' id='reqPhone' name='电话' type='text' size='14' maxlength='50'value=''></div>
</div>
<div class='msgAddText_N'><div style='float:left;' class='msgSubmit_overToPoint'><script>document.write(best.content);</script>：</div><textarea class='g_textarea' id='reqContent' rows='3' cols='50' style='width:610px;' placeholder='' maxlength='1000'></textarea>
</div> 
<div class='msgAddButton_N'>
<div style='float:left;' class='msgSubmit_overToPoint'>&nbsp;</div><div class='m_ibutton m_ibutton6'>
<div class='left'></div><div class='middle' style='min-width:106px;' onclick='msgSubmitAddMsg()' ><script>document.write(best.submitmessage);</script></div><div class='right'></div></div></div><div class='msgFlag_N'> </div> </div>
</div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="msgBoard.aspx.cs" Inherits="Best.msgBoard" %>
...
<link rel='canonical' href='http://www.bestcaps.cn/msgBoard.aspx'>
...
#module15 .contentLineIcon {*padding:0;}
#module15 .contentLineIcon {*width:0;}
...
<body class="g_body g_locale2052 " >
	...
	<div id="g_main" class='g_main g_col9 ' style='0' >
...
<div class='clearfloat clearfloat322'></div>
							...
							<td valign="top" id="containerFormsCenter" class="containerFormsCenter">
								...
								<div id="centerTopForms" class="column forms mainForms centerTopForms" >
									<div id='module15' _indexClass='formIndex1' class='form form15 formIndex1 formStyle50 modulePattern modulePattern73' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='1' _global='false' _independent='false' >
...
<div class='titleText titleText15'><span>留言板</span></div>
</td>
...
<div class='formMiddleContent formMiddleContent15  ' tabStyle='0'>
<div id='msgBoard15' class='msgBoard msgSubmit' style='margin-left:14px;'>
<div id='msgAdd' class='msgSAdd'>
<div class='g_tip msgTips'></div>
<div class='msgSAdd_N'>
<div class='msgAddTitle_N'>发表您的留言：</div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'>姓名：</div><input style='width:246px;' class='g_itext msg_ipt msg_isMust' id='reqName' name='姓名' type='text' size='14' maxlength='50'value=''><font class='star'>*</font></div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'>邮箱：</div><input style='width:246px;' class='g_itext msg_ipt ' id='reqEmail' name='邮箱' type='text' size='14' maxlength='50'value=''></div>
<div style='width: 330px; _width: 350px;' class='msgPanel_N'><div class='msgSubmit_overToPoint' style='float:left;'>电话：</div><input style='width:246px;' class='g_itext msg_ipt ' id='reqPhone' name='电话' type='text' size='14' maxlength='50'value=''></div>
</div>
<div class='msgAddText_N'><div style='float:left;' class='msgSubmit_overToPoint'>内容：</div><textarea class='g_textarea' id='reqContent' rows='3' cols='50' style='width:610px;' placeholder='请输入留言' maxlength='1000'></textarea>
</div> 
<div class='msgAddButton_N'>
<div style='float:left;' class='msgSubmit_overToPoint'>&nbsp;</div><div class='m_ibutton m_ibutton6'>
<div class='left'></div><div class='middle' style='min-width:106px;' onclick='msgSubmitAddMsg()' >提交留言</div><div class='right'></div></div></div><div class='msgFlag_N'> </div> </div>
</div>
<div id='pagenation15' class='pagenation_N'>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = 789988879;
	fk_sale.signupDays = 543;
	fk_sale.signupMinutes = 782526;
...
$(function() {
	...
	// ajax统计
	//Site.total({colId:9, pdId:-1, ndId:-1, sc:0, rf:"http://www.bestcaps.cn/"});
	//前端性能数据上报
	Site.report();
...
$('#pagenation15').find('.pageNo a,.prevShow_model,.nextShow_model,.jumpPageDiv .bottomSearch').hover(function(){$(this).addClass('p_hover')}, function(){$(this).removeClass('p_hover')});

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Best.contact" %>
...
<link rel='canonical' href='http://www.bestcaps.cn/col.aspx?id=102'>
...
<div class='itemSep'></div><table title='' class='item itemCol102 itemIndex6' cellpadding='0' cellspacing='0' colId='102' id='nav102' onclick='window.open("/col.aspx?id=102", "_self")'  _jump='window.open("/col.aspx?id=102", "_self")' >
<tr>
<td class='itemLeft'></td>
<td class='itemCenter'><a hidefocus='true' style='outline:none;' href='/col.aspx?id=102' target='_self' onclick='return false;'><span class='itemName0'>联系我们</span></a></td>
<td class='itemRight'></td>
</tr>
</table>
</div>
...
<div class='clearfloat clearfloat322'></div>
							...
							<td valign="top" id="containerFormsCenter" class="containerFormsCenter">
								...
								<div id="centerTopForms" class="column forms mainForms centerTopForms" >
									<div id='module323' _indexClass='formIndex1' class='form form323 formIndex1 formStyle18 modulePattern modulePattern73' title='' style='' _side='0' _inTab='0' _inMulMCol='0' _inFullmeasure='0' _autoHeight='1' _global='false' _independent='false' >
...
<table class='formBanner formBanner323' cellpadding='0' cellspacing='0'><tr>
<td class='left left323'></td>
<td class='center center323' valign='top'>
<table cellpadding='0' cellspacing='0' class='formBannerTitle formBannerTitle323'><tr>
<td class='titleLeft titleLeft323' valign='top'>
</td>
<td class='titleCenter titleCenter323' valign='top'>
<div class='titleText titleText323'><span>联系我们</span></div>
</td>
...
<table class='formMiddle formMiddle323' style='' cellpadding='0' cellspacing='0'><tr>
...
<div id='mapframe323' name='mapframe' frameborder='0' scrolling='no' height='300' width='600' src='about:blank' style="border:2px solid red;height:200px;width:720px;"></div>
    
    <div id='mapDetailContent'323 style='padding-top: 10px;' ><p style="line-height:2em;"><span style="line-height:1.8;">地址：</span><br /></p><p style="line-height:2em;"><span style="font-size:12px;">电话：</span></p><p style="line-height:2em;"><span style="font-size:12px;">简介：</span></p></div></div>
</td>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = 533949804;
	fk_sale.signupDays = 546;
	fk_sale.signupMinutes = 786794;
...
$(function() {
	...
	// ajax统计
	//Site.total({colId:102, pdId:-1, ndId:-1, sc:0, rf:"http://www.bestcaps.cn/col.aspx?id=101"});
	//前端性能数据上报
	//Site.report();
